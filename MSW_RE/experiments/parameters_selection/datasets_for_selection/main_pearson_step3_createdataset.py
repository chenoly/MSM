...
if __name__ == "__main__":
    ...
    # capture
    parser.add_argument('--digital_medium_path', type=str, default=f"Images/pearson/digital_match/")
    parser.add_argument('--captured_medium_path', type=str, default=f"Images/pearson/scanned_match/")
    parser.add_argument('--save_dir', type=str, default=f"Images/pearson/genuine")

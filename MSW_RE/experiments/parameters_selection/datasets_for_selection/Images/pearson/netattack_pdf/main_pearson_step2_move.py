...
if __name__ == "__main__":
    ...
    # Print arguments
    parser.add_argument('--Nums', type=list, default=[1, 1, 2, 2])
        ...
        for alpha in args.alpha_list:
            for gamma in args.gamma_list:
                ...
                matched_files = glob.glob(
                    os.path.join(args.load_digital_located_dir, f"dpi_{args.print_dpi}_*_{N}_{alpha}_{gamma_str}.png"))
                ...
                if gamma == 0:
                    ...
                    gamma_str = gamma
                matched_files = glob.glob(
                    os.path.join(args.load_scanned_located_dir, f"p_netattack_dpi_{args.print_dpi}_*_{N}_{alpha}_{gamma_str}.png"))

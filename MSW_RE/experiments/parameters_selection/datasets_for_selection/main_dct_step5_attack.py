...
if __name__ == "__main__":
    ...
    # model path
    parser.add_argument('--model_path', type=str, default=f"E:\研究生\主要研究工作\物理不可复制防伪水印\源代码\MSW_NEW\experiments/attack/train_attack_model/checkpoints/generator_0.5.pth")

    # capture
    parser.add_argument('--genuine_dir', type=str, default=f"Images/dct/genuine/")
    parser.add_argument('--save_netattacked_dir', type=str, default=f"Images/dct/counterfeit/NetAttack")
    parser.add_argument('--save_binattacked_dir', type=str, default=f"Images/dct/counterfeit/BinAttack")

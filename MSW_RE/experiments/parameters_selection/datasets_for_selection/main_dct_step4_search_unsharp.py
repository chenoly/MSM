...
if __name__ == "__main__":
    ...
    parser.add_argument('--N_list', type=list, default=[48])
    parser.add_argument('--alpha_list', type=list, default=[0.5])
    parser.add_argument('--gamma_list', type=list, default=[0.04])
    ...
    parser.add_argument('--digital_dir', type=str, default="Images/dct/digital/")
    parser.add_argument('--genuine_dir', type=str, default="Images/dct/genuine/")
    parser.add_argument('--save_netattacked_dir', type=str, default="Images/dct/counterfeit/NetAttack")
    parser.add_argument('--save_binattacked_dir', type=str, default="Images/dct/counterfeit/BinAttack")

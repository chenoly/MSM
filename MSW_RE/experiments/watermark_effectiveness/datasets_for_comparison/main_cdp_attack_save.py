...
if __name__ == "__main__":
    ...
    # File paths
    parser.add_argument('--load_genuine', type=str, default=r"Images/cdp/genuine", help='Path to load the captured medium images.')
    parser.add_argument('--save_attack_medium', type=str, default=r"Images/cdp/attacked_medium", help='Path to save the attacked medium images.')
    parser.add_argument('--save_attack_digital', type=str, default=r"Images/cdp/attacked_medium/attack_digital", help='Path to save the attacked medium images.')
    parser.add_argument('--save_attack_captured', type=str, default=r"Images/cdp/attack_captured_all", help='Path to save the attacked medium images.')

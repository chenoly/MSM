...
def save_datasets(mode_str):
    ...
    # Capture arguments
    parser.add_argument('--load_digital_counterfeit', type=str, default="Images/dct/attacked_medium")
    parser.add_argument('--load_counterfeit', type=str, default="Images/dct/counterfeit")
    parser.add_argument('--load_digital', type=str, default="Images/dct/digital")
    parser.add_argument('--load_genuine', type=str, default="Images/dct/genuine")
    parser.add_argument('--save_datasets', type=str, default="Images/dct/datasets")

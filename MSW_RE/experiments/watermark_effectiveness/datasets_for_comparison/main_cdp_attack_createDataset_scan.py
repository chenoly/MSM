...
def locate_points(mode_str):
    ...
    # File paths
    parser.add_argument('--load_captured_all', type=str, default="Images/cdp/attack_captured_all")
    parser.add_argument('--load_digital_located', type=str, default="Images/cdp/attacked_medium/attack_located")
    parser.add_argument('--save_captured_located', type=str, default="Images/cdp/attack_captured_located")
    parser.add_argument('--save_captured_medium', type=str, default="Images/cdp/attack_captured_medium")
    parser.add_argument('--save_digital_medium', type=str, default="Images/cdp/attack_digital_medium")
...
def create_datasets(mode_str):
    ...
    parser.add_argument('--data_len', type=int, default=5, help='Length of the data.')
    parser.add_argument('--N', type=int, default=48, help='Size of the border in pixels.')
    ...
    parser.add_argument('--scan_ppi', type=int, default=1200, help='Scan resolution in pixels per inch (PPI).')
    # Capture arguments
    parser.add_argument('--load_digital_medium', type=str, default="Images/cdp/attacked_medium/attack_located")
    parser.add_argument('--load_captured_medium', type=str, default="Images/cdp/attack_captured_located")
    parser.add_argument('--save_dir', type=str, default="Images/cdp/counterfeit")
    args = parser.parse_args()

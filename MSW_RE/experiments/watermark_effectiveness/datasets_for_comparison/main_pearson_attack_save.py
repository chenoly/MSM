...
if __name__ == "__main__":
    ...
    # Model paths
    parser.add_argument('--model_pth_path', type=str, default=r"/attack/train_attack_model/checkpoints/encoder_net_alpha_0_6.pth", help='Paths to the model checkpoint files.')

    # File paths
    parser.add_argument('--load_genuine', type=str, default=r"Images/pearson/genuine", help='Path to load the captured medium images.')
    parser.add_argument('--save_attack_medium', type=str, default=r"Images/pearson/attacked_medium", help='Path to save the attacked medium images.')
    parser.add_argument('--save_attack_digital', type=str, default=r"Images/pearson/attacked_medium/attack_digital", help='Path to save the attacked medium images.')
    parser.add_argument('--save_attack_captured', type=str, default=r"Images/pearson/attack_captured_all", help='Path to save the attacked medium images.')

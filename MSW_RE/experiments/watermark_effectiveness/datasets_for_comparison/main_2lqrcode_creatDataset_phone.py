...
from models.utils import Workflow, generate_random_string, find_all_files
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_captured_located', type=str, default=f"Images/2lqrcode/captured_located", help='val_epoch')
    parser.add_argument('--load_captured_all', type=str, default=f"Images/2lqrcode/captured_all", help='val_epoch')
    parser.add_argument('--save_digital_located', type=str, default=f"Images/2lqrcode/digital_located", help='val_epoch')
    ...
    # capture
    parser.add_argument('--load_digital_medium', type=str, default=f"Images/2lqrcode/digital_located/", help='')
    parser.add_argument('--load_captured_medium', type=str, default=f"Images/2lqrcode/captured_located/", help='')
    parser.add_argument('--save_dir', type=str, default=f"Images/2lqrcode/genuine/", help='')
    args = parser.parse_args()

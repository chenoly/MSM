...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_captured_located', type=str, default=f"Images/cdp/captured_located")
    parser.add_argument('--load_captured_all', type=str, default=f"Images/cdp/captured_all")
    parser.add_argument('--save_digital_located', type=str, default=f"Images/cdp/digital_located")
    ...
    # capture
    parser.add_argument('--load_digital_medium', type=str, default=f"Images/cdp/digital_located/")
    parser.add_argument('--load_captured_medium', type=str, default=f"Images/cdp/captured_located/")
    parser.add_argument('--save_dir', type=str, default=f"Images/cdp/genuine/")
    args = parser.parse_args()

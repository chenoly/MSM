...
if __name__ == "__main__":
    ...
    WF.generate(args.save_dir, args.Num, model, data_len=args.data_len, alpha=args.alpha, gamma=args.gamma,
                mode=args.mode, print_dpi=args.print_dpi, inner_border_mm=args.inner_border_mm,
